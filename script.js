...
const projectData = {
  ...
  maxpayne2: {
    ...
    bodyContent: '<p>I worked as development support during the finalization of Max Payne 2, hunting down and writing up bug reports.</p><p>We had to run through all different versions of the game in multiple languages. The PS2 version was particularly rough and many compromises had to be made to get it running on that platform.</p><figure><img src="images/MaxPayne2_PlatformComparison.png" alt="Platform comparison"><figcaption>Comparison of the difference between platforms</figcaption></figure>',
    contributions: [
